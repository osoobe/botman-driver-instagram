...
use BotMan\Drivers\Instagram\Events\MessagingDeliveries;
use BotMan\Drivers\Instagram\Events\MessagingOptins;
use BotMan\Drivers\Instagram\Events\MessagingReads;
use BotMan\Drivers\Instagram\Events\MessagingReferrals;
use BotMan\Drivers\Instagram\Exceptions\InstagramException;
use BotMan\Drivers\Instagram\Extensions\Airline\AirlineBoardingPass;
use BotMan\Drivers\Instagram\Extensions\AirlineCheckInTemplate;
use BotMan\Drivers\Instagram\Extensions\AirlineItineraryTemplate;
use BotMan\Drivers\Instagram\Extensions\AirlineUpdateTemplate;
use BotMan\Drivers\Instagram\Extensions\ButtonTemplate;
use BotMan\Drivers\Instagram\Extensions\GenericTemplate;
use BotMan\Drivers\Instagram\Extensions\ListTemplate;
use BotMan\Drivers\Instagram\Extensions\MediaTemplate;
use BotMan\Drivers\Instagram\Extensions\OpenGraphTemplate;
use BotMan\Drivers\Instagram\Extensions\ReceiptTemplate;
use BotMan\Drivers\Instagram\Extensions\User;
use Illuminate\Support\Collection;
use Symfony\Component\HttpFoundation\ParameterBag;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Response;

class InstagramDriver extends HttpDriver implements VerifiesService
{
    ...
    protected $instagramProfileEndpoint = 'https://graph.facebook.com/v11.0/';

    /** @var bool If the incoming request is a FB postback */
    protected $isPostback = false;

    const DRIVER_NAME = 'Instagram';
    ...
    public function markSeen(IncomingMessage $matchingMessage)
    {
        ...
        return $this->http->post($this->instagramProfileEndpoint.'me/messages', [], $parameters);
    }
    ...
    {
        // Instagram bot replies don't get returned
        return false;
    }
    ...
    /**
     * Convert a Question object into a valid Instagram
    ...
    {
        $response = $this->http->post($this->instagramProfileEndpoint.'me/messages', [], $payload);
    ...
    public function getUserWithFields(array $fields, IncomingMessage $matchingMessage)
    {
        ...
        // WORKPLACE (Instagram for companies)
        ...
        $userInfoData = $this->http->get($this->instagramProfileEndpoint.$matchingMessage->getSender().'?fields='.$fields.'&access_token='.$this->config->get('token'));
    ...
    public function getUser(IncomingMessage $matchingMessage)
    {
        ...
        // field string available at Instagram
    ...
    public function sendRequest($endpoint, array $parameters, IncomingMessage $matchingMessage)
    {
        ...
        return $this->http->post($this->instagramProfileEndpoint.$endpoint, [], $parameters);
    }
    ...
    /**
     * @param Response $instagramResponse
     * @return mixed
     * @throws InstagramException
     */
    protected function throwExceptionIfResponseNotOk(Response $instagramResponse)
    {
        if ($instagramResponse->getStatusCode() !== 200) {
            $responseData = json_decode($instagramResponse->getContent(), true);
            throw new InstagramException('Error sending payload: '.$responseData['error']['message']);
        }
    }
    ...
    {
        return $this->http->post($this->instagramProfileEndpoint.'me/pass_thread_control?access_token='.$this->config->get('token'), [], [
            'recipient' => [
